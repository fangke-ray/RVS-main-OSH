		...
		objCode.onkeyup = function(e){
			...
			if (this.value.length == 8 || this.value.length == 13){
				...
				time = setTimeout(function(){
					clearTimeout(time);
					document.forms["componentManageForm"].action = "pda_component_outstock.do?method=getDetail";
...
<body>
	<html:form action="/pda_component_outstock" method="post" onsubmit="return false">
		...
		<div class="header" style="height:40px;">
			...
			<div class="right" style="color:#fff;margin-right:10px;">
				...
				<div style="text-align:right;">
					<h5>组装完成组件数： <bean:write name="componentManageForm" property="count"/></h5>
				</div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="main" style="height:130px;padding:10px;overflow-y:scroll;overflow-x:hidden;">
			<table style="width:95%">
				<tr>
					...
					<th class="td-title" style="width:60px;">组件序列号</th>
