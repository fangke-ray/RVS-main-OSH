			...
			<div class="main" style="height:130px;padding:10px;">
				...
				<div class="right" style="width:128px;border:1px solid;">
					<div style="width:128px;height:128px;">
						<img style="max-width:128px;max-height:128px;" src="<logic:notEmpty name="pdaApplyElementForm">/photos/consumable/<bean:write name="pdaApplyElementForm" property="code"/></logic:notEmpty>_fix.jpg" alt="128*128图片" onerror="javascript:this.src='images/noimage128x128.gif'"/>
					</div>
				</div>
				<div class="clear"></div>
			</div>
