...
<div class="ui-widget-header ui-corner-top ui-helper-clearfix areaencloser dwidth-full">
	<span class="areatitle">使用 D/E 组件</span>
</div>
<div class="ui-widget-content dwidth-full" id="select_snout">
	...
	<div style="height: 44px">
		<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" id="unusesnoutbutton" value="取消使用 D/E 组件" role="button" aria-disabled="false" style="float: right; right: 2px;">
	</div>
</div>
...
<div class="referchooser ui-widget-content" tabindex="-1" style="z-index:80;">
	<table class="subform" id="snouts">
		<thead><th class="ui-state-default" style="padding: 0 0.5em;">C 本体来源<br>维修编号</th><th class="ui-state-default" style="padding: 0 0.5em;">D/E 组件管理号</th><th class="ui-state-default" style="padding: 0 0.5em;">位置</th></thead>
		<tbody></tbody>
	</table>
</div>
