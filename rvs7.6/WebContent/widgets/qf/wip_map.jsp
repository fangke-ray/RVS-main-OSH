<%@ page language="java" pageEncoding="UTF-8" contentType="text/html;charset=UTF-8" isELIgnored="false"%>
	...
	<div class="ui-widget-content">
		<div class="shelf_model" for="endoscope">
		...
		<div style="margin: 15px; float: left;">
			...
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					...
					<th class="ui-state-default" style="width: 14px;">Ｃ</th>
					<th class="ui-state-default" style="width: 14px;">Ｄ</th>
					<th class="ui-state-default" style="width: 14px;">Ｅ</th><th class="ui-state-default" style="width: 14px;">Ｆ</th>
				</tr>
<tr>
<td wipid="2A1">1</td>
<td wipid="2B1">1</td>
...
<td wipid="10F9">9</td>
		...
		<div style="margin: 15px; float: left;">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架１１(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
					<th class="ui-state-default" style="width: 14px;">Ｂ</th>
...
<td wipid="11F9">9</td>
		...
		<div style="margin: 15px; float: left;">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架１２(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
					<th class="ui-state-default" style="width: 14px;">Ｂ</th>
...
<td wipid="13H6">6</td>
		...
		<div style="margin: 15px; float: left;">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架１４(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
					<th class="ui-state-default" style="width: 14px;">Ｂ</th>
