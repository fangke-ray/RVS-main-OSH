...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-top ui-accordion-icons" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>展示一览</h3>
	...
	一课工程展示: <br>
        <a title="分解工程线长界面" target="_parent" href="show.do#lineSituationE1">分解</a> <a title="NS工程线长界面" target="_parent" href="show.do#lineLeaderN1">NS</a> <a title="总组工程线长界面" target="_parent" href="show.do#lineSituationP1">总组</a><br>
	二课工程展示: <br>
